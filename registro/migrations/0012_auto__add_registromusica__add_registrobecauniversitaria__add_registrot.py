...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registro_registromusica', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 4, 26, 0, 0))),
        ...
        # Adding model 'RegistroBecaUniversitaria'
        db.create_table('registro_registrobecauniversitaria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 4, 26, 0, 0))),
            ('persona', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['registro.Persona'], unique=True)),
        ))
        db.send_create_signal('registro', ['RegistroBecaUniversitaria'])
        ...
        # Adding model 'RegistroBecaSecundaria'
        db.create_table('registro_registrobecasecundaria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 4, 26, 0, 0))),
            ('persona', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['registro.Persona'], unique=True)),
        ))
        db.send_create_signal('registro', ['RegistroBecaSecundaria'])
        ...
        # Adding model 'RegistroBecaPrimaria'
        db.create_table('registro_registrobecaprimaria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 4, 26, 0, 0))),
            ('persona', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['registro.Persona'], unique=True)),
        ))
        db.send_create_signal('registro', ['RegistroBecaPrimaria'])

    def backwards(self, orm):
        # Deleting model 'RegistroMusica'
        db.delete_table('registro_registromusica')

        # Deleting model 'RegistroBecaUniversitaria'
        db.delete_table('registro_registrobecauniversitaria')

        # Deleting model 'RegistroTeatro'
        db.delete_table('registro_registroteatro')

        # Deleting model 'RegistroBecaSecundaria'
        db.delete_table('registro_registrobecasecundaria')
        ...
        # Deleting model 'RegistroBecaPrimaria'
        db.delete_table('registro_registrobecaprimaria')
