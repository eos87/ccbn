...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventoInterno'
        db.create_table('prevencion_eventointerno', (
            ...
            ('tematica', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('prevencion', ['EventoInterno'])

        # Adding model 'EventoExterno'
        db.create_table('prevencion_eventoexterno', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')()),
            ('lugar', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('actividad', self.gf('django.db.models.fields.IntegerField')()),
            ('facilitadores', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('prevencion', ['EventoExterno'])

    def backwards(self, orm):
        # Deleting model 'EventoInterno'
        db.delete_table('prevencion_eventointerno')

        # Deleting model 'EventoExterno'
        db.delete_table('prevencion_eventoexterno')
