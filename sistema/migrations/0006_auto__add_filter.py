...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Filter'
        db.create_table('sistema_filter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('salida', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sistema.Salida'])),
            ('field', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('criteria', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True)),
            ('value', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
        ))
        db.send_create_signal('sistema', ['Filter'])

    def backwards(self, orm):
        # Deleting model 'Filter'
        db.delete_table('sistema_filter')

    models = {
        'sistema.filter': {
            'Meta': {'object_name': 'Filter'},
            'criteria': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            'field': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'salida': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sistema.Salida']"}),
            'value': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'})
        },
        'sistema.modulo': {
