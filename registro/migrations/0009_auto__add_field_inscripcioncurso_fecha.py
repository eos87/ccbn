...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InscripcionCurso.fecha'
        db.add_column('registro_inscripcioncurso', 'fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 17, 13, 7, 55, 542641), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InscripcionCurso.fecha'
        db.delete_column('registro_inscripcioncurso', 'fecha')
