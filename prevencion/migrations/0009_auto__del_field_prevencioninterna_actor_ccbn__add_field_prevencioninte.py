...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PrevencionInterna.relacion_ccbn'
        db.add_column('prevencion_prevencioninterna', 'relacion_ccbn',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PrevencionInterna.actor_ccbn'
        raise RuntimeError("Cannot reverse this migration. 'PrevencionInterna.actor_ccbn' and its values cannot be restored.")
        # Deleting field 'PrevencionInterna.relacion_ccbn'
        db.delete_column('prevencion_prevencioninterna', 'relacion_ccbn')
