...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Filter.value'
        db.alter_column('sistema_filter', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Filter.value'
        db.alter_column('sistema_filter', 'value', self.gf('django.db.models.fields.CharField')(max_length=50))
