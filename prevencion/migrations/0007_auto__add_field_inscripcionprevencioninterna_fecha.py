...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InscripcionPrevencionInterna.fecha'
        db.add_column('prevencion_inscripcionprevencioninterna', 'fecha',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 6, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InscripcionPrevencionInterna.fecha'
        db.delete_column('prevencion_inscripcionprevencioninterna', 'fecha')
