...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActividadIndividual'
        db.create_table('biblioteca_actividadindividual', (
        ...
        db.send_create_signal('biblioteca', ['ActividadIndividual'])

        # Adding model 'Consulta'
        db.create_table('biblioteca_consulta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actividad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.ActividadIndividual'])),
            ('categoria', self.gf('django.db.models.fields.IntegerField')()),
            ('proposito', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('biblioteca', ['Consulta'])

        # Adding model 'Prestamo'
        db.create_table('biblioteca_prestamo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actividad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.ActividadIndividual'])),
            ('registro_libro_prestar', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('dias', self.gf('django.db.models.fields.IntegerField')()),
            ('fecha_retorno', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('biblioteca', ['Prestamo'])

        # Adding model 'Retorno'
        db.create_table('biblioteca_retorno', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actividad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.ActividadIndividual'])),
            ('registro_libro_retorno', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('dias_mora', self.gf('django.db.models.fields.IntegerField')()),
            ('fecha_retorno', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('biblioteca', ['Retorno'])

        # Adding model 'Servicio'
        db.create_table('biblioteca_servicio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('actividad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.ActividadIndividual'])),
            ('capacidad_tecnica', self.gf('django.db.models.fields.IntegerField')()),
            ('compromiso_social', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('biblioteca', ['Servicio'])

        # Adding model 'ActividadColectiva'
        db.create_table('biblioteca_actividadcolectiva', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')()),
            ('actividad', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('evaluacion_rapida', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('biblioteca', ['ActividadColectiva'])

    def backwards(self, orm):
        # Deleting model 'ActividadIndividual'
        db.delete_table('biblioteca_actividadindividual')

        # Deleting model 'Consulta'
        db.delete_table('biblioteca_consulta')

        # Deleting model 'Prestamo'
        db.delete_table('biblioteca_prestamo')

        # Deleting model 'Retorno'
        db.delete_table('biblioteca_retorno')

        # Deleting model 'Servicio'
        db.delete_table('biblioteca_servicio')

        # Deleting model 'ActividadColectiva'
        db.delete_table('biblioteca_actividadcolectiva')
