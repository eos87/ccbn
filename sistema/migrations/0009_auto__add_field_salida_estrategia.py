...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Salida.estrategia'
        db.add_column('sistema_salida', 'estrategia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sistema.Estrategia']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Salida.estrategia'
        db.delete_column('sistema_salida', 'estrategia_id')
