...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Persona.docente_ccbn'
        db.delete_column('registro_persona', 'docente_ccbn')

        # Deleting field 'Persona.personal_ccbn'
        db.delete_column('registro_persona', 'personal_ccbn')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Persona.docente_ccbn'
        raise RuntimeError("Cannot reverse this migration. 'Persona.docente_ccbn' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Persona.personal_ccbn'
        raise RuntimeError("Cannot reverse this migration. 'Persona.personal_ccbn' and its values cannot be restored.")
