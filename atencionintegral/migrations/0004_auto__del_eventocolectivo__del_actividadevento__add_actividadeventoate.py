...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActividadEventoAtencion'
        db.create_table('atencionintegral_actividadeventoatencion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('atencionintegral', ['ActividadEventoAtencion'])

        # Adding model 'EventoColectivoAtencion'
        db.create_table('atencionintegral_eventocolectivoatencion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('actividad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atencionintegral.ActividadEventoAtencion'])),
        ...
        db.send_create_signal('atencionintegral', ['EventoColectivoAtencion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ActividadEventoAtencion'
        db.delete_table('atencionintegral_actividadeventoatencion')

        # Deleting model 'EventoColectivoAtencion'
        db.delete_table('atencionintegral_eventocolectivoatencion')
