...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NombresActividades'
        db.create_table('biblioteca_nombresactividades', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('biblioteca', ['NombresActividades'])


        # Renaming column for 'ActividadColectiva.actividad' to match new field type.
        db.rename_column('biblioteca_actividadcolectiva', 'actividad', 'actividad_id')
        # Changing field 'ActividadColectiva.actividad'
        db.alter_column('biblioteca_actividadcolectiva', 'actividad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biblioteca.NombresActividades']))
        # Adding index on 'ActividadColectiva', fields ['actividad']
        db.create_index('biblioteca_actividadcolectiva', ['actividad_id'])


    def backwards(self, orm):
        # Removing index on 'ActividadColectiva', fields ['actividad']
        db.delete_index('biblioteca_actividadcolectiva', ['actividad_id'])

        # Deleting model 'NombresActividades'
        db.delete_table('biblioteca_nombresactividades')


        # Renaming column for 'ActividadColectiva.actividad' to match new field type.
        db.rename_column('biblioteca_actividadcolectiva', 'actividad_id', 'actividad')
        # Changing field 'ActividadColectiva.actividad'
        db.alter_column('biblioteca_actividadcolectiva', 'actividad', self.gf('django.db.models.fields.IntegerField')())

    models = {
        'biblioteca.actividadcolectiva': {
            'Meta': {'object_name': 'ActividadColectiva'},
            'actividad': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['biblioteca.NombresActividades']"}),
        ...
        'biblioteca.actividadindividual': {
            'Meta': {'ordering': "['-fecha']", 'object_name': 'ActividadIndividual'},
        ...
        'biblioteca.nombresactividades': {
            'Meta': {'object_name': 'NombresActividades'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'biblioteca.prestamo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['biblioteca.Libro']"})
        },
        'biblioteca.retorno': {
