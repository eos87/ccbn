...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relacion.persona'
        db.add_column('registro_relacion', 'persona', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['registro.Persona']), keep_default=False)

        # Adding field 'Relacion.owner'
        db.add_column('registro_relacion', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owner', to=orm['registro.Persona']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Relacion.persona'
        db.delete_column('registro_relacion', 'persona_id')

        # Deleting field 'Relacion.owner'
        db.delete_column('registro_relacion', 'owner_id')
