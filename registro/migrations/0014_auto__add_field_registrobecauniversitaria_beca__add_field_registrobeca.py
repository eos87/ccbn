...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistroBecaUniversitaria.beca'
        db.add_column('registro_registrobecauniversitaria', 'beca',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['atencionintegral.BecaUniversitaria']),
                      keep_default=False)

        # Adding field 'RegistroBecaSecundaria.beca'
        db.add_column('registro_registrobecasecundaria', 'beca',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['atencionintegral.BecaSecundaria']),
                      keep_default=False)

        # Adding field 'RegistroBecaPrimaria.beca'
        db.add_column('registro_registrobecaprimaria', 'beca',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['atencionintegral.BecaPrimaria']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RegistroBecaUniversitaria.beca'
        db.delete_column('registro_registrobecauniversitaria', 'beca_id')

        # Deleting field 'RegistroBecaSecundaria.beca'
        db.delete_column('registro_registrobecasecundaria', 'beca_id')

        # Deleting field 'RegistroBecaPrimaria.beca'
        db.delete_column('registro_registrobecaprimaria', 'beca_id')
