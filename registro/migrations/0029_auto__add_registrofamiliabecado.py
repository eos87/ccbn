...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegistroFamiliaBecado'
        db.create_table('registro_registrofamiliabecado', (
            ...
            ('beca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atencionintegral.FamiliaBecado'])),
            ('formacion_acompa', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mejora_relacion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('sens_derecho_edu', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('part_soya', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('madre_en_curso', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('padre_en_curso', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hermano_en_curso', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('registro', ['RegistroFamiliaBecado'])


    def backwards(self, orm):
        # Deleting model 'RegistroFamiliaBecado'
        db.delete_table('registro_registrofamiliabecado')
