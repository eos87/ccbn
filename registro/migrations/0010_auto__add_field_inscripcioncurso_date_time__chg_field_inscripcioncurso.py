...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InscripcionCurso.date_time'
        db.add_column('registro_inscripcioncurso', 'date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 19, 15, 23, 15, 458288), blank=True), keep_default=False)

        # Changing field 'InscripcionCurso.fecha'
        db.alter_column('registro_inscripcioncurso', 'fecha', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Deleting field 'InscripcionCurso.date_time'
        db.delete_column('registro_inscripcioncurso', 'date_time')

        # Changing field 'InscripcionCurso.fecha'
        db.alter_column('registro_inscripcioncurso', 'fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 4, 19)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
