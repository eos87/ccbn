...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.j_oficio'
        db.alter_column('registro_persona', 'j_oficio_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['registro.Oficio']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Persona.j_oficio'
        raise RuntimeError("Cannot reverse this migration. 'Persona.j_oficio' and its values cannot be restored.")
