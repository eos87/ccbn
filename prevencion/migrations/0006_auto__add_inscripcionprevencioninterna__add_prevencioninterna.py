...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InscripcionPrevencionInterna'
        db.create_table('prevencion_inscripcionprevencioninterna', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.Persona'])),
            ('pvbg_interna', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prevencion.PrevencionInterna'])),
            ('asistencia', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('razon_no_asistir', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('calificacion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mejora_autoestima', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nivel_conocimiento', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('calidad_contenido', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('metodologia', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('empoderamiento', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('prevencion', ['InscripcionPrevencionInterna'])

        # Adding model 'PrevencionInterna'
        db.create_table('prevencion_prevencioninterna', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('semestre', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('prevencion', ['PrevencionInterna'])


    def backwards(self, orm):
        # Deleting model 'InscripcionPrevencionInterna'
        db.delete_table('prevencion_inscripcionprevencioninterna')

        # Deleting model 'PrevencionInterna'
        db.delete_table('prevencion_prevencioninterna')
