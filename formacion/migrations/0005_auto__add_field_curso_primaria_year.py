...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Curso.primaria_year'
        db.add_column('formacion_curso', 'primaria_year',
                      self.gf('django.db.models.fields.IntegerField')(default=4),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Curso.primaria_year'
        db.delete_column('formacion_curso', 'primaria_year')
