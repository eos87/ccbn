...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.tipo_familia'
        db.alter_column('registro_persona', 'tipo_familia', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Persona.tipo_familia'
        raise RuntimeError("Cannot reverse this migration. 'Persona.tipo_familia' and its values cannot be restored.")
