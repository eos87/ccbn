...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegistroBiblioteca'
        db.create_table('registro_registrobiblioteca', (
        ...
        db.send_create_signal('registro', ['RegistroBiblioteca'])

    def backwards(self, orm):
        # Deleting model 'RegistroBiblioteca'
        db.delete_table('registro_registrobiblioteca')
