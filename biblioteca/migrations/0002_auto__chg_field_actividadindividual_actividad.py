...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActividadIndividual.actividad'
        db.alter_column('biblioteca_actividadindividual', 'actividad', self.gf('django.db.models.fields.CharField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'ActividadIndividual.actividad'
        db.alter_column('biblioteca_actividadindividual', 'actividad', self.gf('django.db.models.fields.IntegerField')())
    models = {
