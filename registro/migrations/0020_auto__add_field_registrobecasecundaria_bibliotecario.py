...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistroBecaSecundaria.bibliotecario'
        db.add_column('registro_registrobecasecundaria', 'bibliotecario',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistroBecaSecundaria.bibliotecario'
        db.delete_column('registro_registrobecasecundaria', 'bibliotecario')
