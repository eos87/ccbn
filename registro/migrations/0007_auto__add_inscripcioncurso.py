...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InscripcionCurso'
        db.create_table('registro_inscripcioncurso', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.Persona'])),
            ('curso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formacion.Curso'])),
            ('becado', self.gf('django.db.models.fields.IntegerField')()),
            ('estado', self.gf('django.db.models.fields.IntegerField')()),
            ('xq_no_termino', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('mejora_vida', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('registro', ['InscripcionCurso'])


    def backwards(self, orm):
        
        # Deleting model 'InscripcionCurso'
        db.delete_table('registro_inscripcioncurso')
