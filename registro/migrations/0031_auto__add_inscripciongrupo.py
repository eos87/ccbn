...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InscripcionGrupo'
        db.create_table('registro_inscripciongrupo', (
            ...
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promocion.Grupo'])),
            ('date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('registro', ['InscripcionGrupo'])


    def backwards(self, orm):
        # Deleting model 'InscripcionGrupo'
        db.delete_table('registro_inscripciongrupo')
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
