...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InscripcionCurso.continua_estudiando'
        db.add_column('registro_inscripcioncurso', 'continua_estudiando',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InscripcionCurso.continua_estudiando'
        db.delete_column('registro_inscripcioncurso', 'continua_estudiando')
