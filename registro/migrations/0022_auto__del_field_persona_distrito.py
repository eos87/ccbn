...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Persona.distrito'
        db.delete_column('registro_persona', 'distrito_id')


    def backwards(self, orm):
        # Adding field 'Persona.distrito'
        db.add_column('registro_persona', 'distrito',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(default=None, to=orm['lugar.Distrito']),
                      keep_default=False)
