...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Persona.distrito' to match new field type.
        db.rename_column('registro_persona', 'distrito', 'distrito_id')
        # Changing field 'Persona.distrito'
        db.alter_column('registro_persona', 'distrito_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Distrito']))
        # Adding index on 'Persona', fields ['distrito']
        db.create_index('registro_persona', ['distrito_id'])


    def backwards(self, orm):
        # Removing index on 'Persona', fields ['distrito']
        db.delete_index('registro_persona', ['distrito_id'])


        # Renaming column for 'Persona.distrito' to match new field type.
        db.rename_column('registro_persona', 'distrito_id', 'distrito')
        # Changing field 'Persona.distrito'
        db.alter_column('registro_persona', 'distrito', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 19, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'registro.persona': {
            ...
            'distrito': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['lugar.Distrito']"}),
