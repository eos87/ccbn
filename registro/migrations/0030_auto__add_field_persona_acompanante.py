...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.acompanante'
        db.add_column('registro_persona', 'acompanante',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.acompanante'
        db.delete_column('registro_persona', 'acompanante')
