...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.docente'
        db.add_column('registro_persona', 'docente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.personal'
        db.add_column('registro_persona', 'personal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.alumno'
        db.add_column('registro_persona', 'alumno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.visitante'
        db.add_column('registro_persona', 'visitante',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.becado'
        db.add_column('registro_persona', 'becado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.promotor'
        db.add_column('registro_persona', 'promotor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.beneficiario'
        db.add_column('registro_persona', 'beneficiario',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.integrante'
        db.add_column('registro_persona', 'integrante',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.docente'
        db.delete_column('registro_persona', 'docente')

        # Deleting field 'Persona.personal'
        db.delete_column('registro_persona', 'personal')

        # Deleting field 'Persona.alumno'
        db.delete_column('registro_persona', 'alumno')

        # Deleting field 'Persona.visitante'
        db.delete_column('registro_persona', 'visitante')

        # Deleting field 'Persona.becado'
        db.delete_column('registro_persona', 'becado')

        # Deleting field 'Persona.promotor'
        db.delete_column('registro_persona', 'promotor')

        # Deleting field 'Persona.beneficiario'
        db.delete_column('registro_persona', 'beneficiario')

        # Deleting field 'Persona.integrante'
        db.delete_column('registro_persona', 'integrante')
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
