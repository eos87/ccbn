...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.tiene_hijos'
        db.add_column('registro_persona', 'tiene_hijos',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.tiene_hijos'
        db.delete_column('registro_persona', 'tiene_hijos')
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'registro.persona': {
            ...
            'tiene_hijos': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
