...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Estrategia'
        db.create_table('sistema_estrategia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.TextField')()),
            ('programa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sistema.Modulo'])),
        ))
        db.send_create_signal('sistema', ['Estrategia'])

    def backwards(self, orm):
        # Deleting model 'Estrategia'
        db.delete_table('sistema_estrategia')
