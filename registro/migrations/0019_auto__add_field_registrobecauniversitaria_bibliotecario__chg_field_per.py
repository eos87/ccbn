...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistroBecaUniversitaria.bibliotecario'
        db.add_column('registro_registrobecauniversitaria', 'bibliotecario',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Persona.ciudad'
        db.alter_column('registro_persona', 'ciudad_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Ciudad']))

        # Changing field 'Persona.barrio'
        db.alter_column('registro_persona', 'barrio_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Barrio']))

    def backwards(self, orm):
        # Deleting field 'RegistroBecaUniversitaria.bibliotecario'
        db.delete_column('registro_registrobecauniversitaria', 'bibliotecario')


        # Changing field 'Persona.ciudad'
        db.alter_column('registro_persona', 'ciudad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lugar.Ciudad']))

        # Changing field 'Persona.barrio'
        db.alter_column('registro_persona', 'barrio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lugar.Barrio']))
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
