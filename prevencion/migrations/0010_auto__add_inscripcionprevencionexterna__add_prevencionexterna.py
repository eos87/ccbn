...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InscripcionPrevencionExterna'
        db.create_table('prevencion_inscripcionprevencionexterna', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.Persona'])),
            ('pvbg_externa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prevencion.PrevencionExterna'])),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 10, 0, 0))),
            ('proceso_formacion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('vulnerabilidad', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('comp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('autonomia', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('accion_comunitaria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('respeto', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('prevencion', ['InscripcionPrevencionExterna'])

        # Adding model 'PrevencionExterna'
        db.create_table('prevencion_prevencionexterna', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('semestre', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('prevencion', ['PrevencionExterna'])


    def backwards(self, orm):
        # Deleting model 'InscripcionPrevencionExterna'
        db.delete_table('prevencion_inscripcionprevencionexterna')

        # Deleting model 'PrevencionExterna'
        db.delete_table('prevencion_prevencionexterna')
    ...
    models = {
        ...
        'prevencion.inscripcionprevencionexterna': {
            'Meta': {'object_name': 'InscripcionPrevencionExterna'},
            'accion_comunitaria': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'autonomia': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'comp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'persona': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registro.Persona']"}),
            'proceso_formacion': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'pvbg_externa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['prevencion.PrevencionExterna']"}),
            'respeto': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'vulnerabilidad': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        'prevencion.prevencionexterna': {
            'Meta': {'object_name': 'PrevencionExterna'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'prevencion.prevencioninterna': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'relacion_ccbn': ('django.db.models.fields.IntegerField', [], {}),
            'semestre': ('django.db.models.fields.IntegerField', [], {}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
        'registro.colegio': {
