...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.jefe_familia'
        db.alter_column('registro_persona', 'jefe_familia', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Persona.jefe_familia'
        raise RuntimeError("Cannot reverse this migration. 'Persona.jefe_familia' and its values cannot be restored.")
    ...
    models = {
        ...
        'registro.inscripcioncurso': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
